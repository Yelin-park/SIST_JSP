...
<body>
<h3>days08/board/write.jsp</h3>

<div align="center">
 <h2>글쓰기</h2>
 <!-- action 속성 값을 안줬기 때문에 자기 자신을 호출
 list.do에서 글쓰기 링크 태그를 클릭 후 write.do 요청 URL로 WriteHandler.java 서블릿 호출하여 포워딩 되어져 wirte.do 출력이 되어졌기 때문에
 해당 페이지에서 form 태그를 submit하면 WriteHandler.java가 다시 호출되어짐 -->
 <!-- method가 post 이기 때문에 WriteHandler.java 컨트롤 핸들러 에서 doPost() 메서드 호출 -->
