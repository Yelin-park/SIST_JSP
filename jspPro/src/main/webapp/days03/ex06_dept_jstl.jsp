...
<%
	...
	// 아래 코딩 안해도됨
	// 포워딩될 때 list -> request.setAttriubute() 가져오는 코딩
...
<!-- items로 iterator와 while문 만들고 var로 변수 dto 생성해서 그 아이템을 넣고
	option 태그 안에 값으로 dto 안에 있는 deptno 가져오고 콘텐츠에는 dname 가져온다. -->
<%--
	<%
